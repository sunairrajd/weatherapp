  ...
  // text(footer, 15, 300, 400, 600);
    ...
    //  myday = ['sunday', 'monday'];
      ...
      fhrsfromsun = random(hrsfromsun);
              ...
              var sen2 = ["A frog jumps", "Donkeys flank", "The worm wiggles", "A parrot asks " + lexicon.randomWord('rb'),  "The oceans loud", "A cat watches traffic", "A cat watches " + fdaytime + " traffic", "A cat watches " + fmonth + " traffic", "The parrot sings <rb>", "Two butterflies warm the road", "Spider webs and plastic bags", "Someone is upset", "Empty bottle " + lexicon.randomWord('vbz') +' ' + lexicon.randomWord('rb'), "A loudspeaker barks", "A frog jumps", "Leaves tremble", "A silkworm spinning", "A worm digs silently still", "A sparrow bathes", "The sunflower drips", "A sparrow takes a dust bath", "A sparrow chips","Road and sky align", "A butterfly trapped", "An ant climbs",  "The birds cry", "Bullfrogs croak",  "A cow stares the road", "Buzzards wait", "Leaves fall",   "Dead batteries", "The cat watches", "Who cares how stocks did",  "Butterfly wings clap" , "my shadow grows", "my shadow grows " + lexicon.randomWord('rb'), "Obama is busy", fdaytime + " is falling" ];

              var senb2 = ["At "+ fmylocation, "A " +fweather + ' ' + fdaytime, fdaytime + " stillness", fmyday + " " + fdaytime, "fweather " + fmyday + ' ' + fdaytime];
              ...
              var senc3 = [fdaytime + " passes in " + fmylocation , "A bus passes by in " + fmylocation , fdaytime +" is falling" ];
                      ...
                      rg = new RiGrammar();
                      rg.addRule("<start>","a % <line-a1> % <line-a2> % <line-a3> | b % <line-b1> % <line-b2> % <line-b3> | c % <line-c1> % <line-c2> % <line-c3> | d % <line-d1> % <line-d2> % <line-d3> | e % <line-e1> % <line-e2> % <line-e3>  " , 1);
                      ...
                      rg2 = new RiGrammar();
                      rg2.addRule("<word-5>",  " Good "  + fdaytime + " from " + fmylocation  + " | " + "- Somewhere around " + fmylocation + " | - " + fmylocation + " Says hi" + " | " + "- Wishes from " + fmylocation  + " | " + "- with love from " + fmylocation   , 1);
